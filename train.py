...
def parse_args():
    ...
    parser.add_argument('--corrupt_aug', action='store_true')

    # dataset related
    parser.add_argument('--data_dir', default='data')
    parser.add_argument('--per_batch_size', default=6, type=int, help='Batch size for Training. Default: 32.')

    # network related
    parser.add_argument('--pretrained_backbone', default='weights/yolov4_ascend_v120_coco2017_official_cv_bs8_acc43.ckpt', type=str,
    ...
    parser.add_argument('--resize_rate', default=1,
    ...
    args.annFile = os.path.join(args.data_dir, 'annotations/annotations_train.json')
    ...
    # logger
    args.outputs_dir = args.ckpt_path
...
def train():
    ...
    init_seeds()
    args.logger.info("================")
    args.logger.info(f'corrupt_aug:{args.corrupt_aug}')
    args.logger.info("================")
    ...
    ds, data_size = create_yolo_dataset(image_dir=args.data_root, anno_path=args.annFile, is_training=True,
                                        ...
                                        device_num=args.group_size, rank=args.rank, config=config, corrupt_aug=args.corrupt_aug)
